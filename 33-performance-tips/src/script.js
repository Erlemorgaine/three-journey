...
// With showpanel you can choose which stat(s) you want to show
// In our case we will see 60 fps, but if you do heavy stuff you fill see the framerate drop
// because performance drops
stats.showPanel(0);
...
// // Tip 4
// Here you get information about the renderer
...
// This creates 1 geometry from all the geonetries.
// There will be only one draw call!
