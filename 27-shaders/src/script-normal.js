...
import glowFragmentShader from "./shaders/test/glowFragment.glsl";
import normalVertexShader from "./shaders/test/normalVertex.glsl";
...
const flagTexture = textureLoader.load("/textures/aurora.png");
...
const material = new THREE.RawShaderMaterial({
  ...
  uniforms: {
    ...
    uResolution: { value: { x: 1400.0, y: 789.0 } },
  },
